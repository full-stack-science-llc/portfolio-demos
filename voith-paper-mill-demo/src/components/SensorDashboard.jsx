...
import { SENSORS, COMPONENTS, SENSOR_CONFIG } from '../constants/millData';

function SensorDashboard({ liveData, selectedComponent, chartData, onClose }) {
      ...
      <div className="flex items-center justify-between p-6 border-b border-voith-gray-200 bg-gradient-to-r from-voith-gray-50 to-white rounded-t-xl">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-sm text-voith-gray-600 mt-1">Real-time sensor monitoring</p>
          </div>
        </div>
                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  {currentValue !== undefined && (
                    <span className={`text-sm font-semibold ${
                      ...
                      status === 'warning' ? 'text-amber-600' : 'text-voith-gray-700'
                    }`}>
